document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderInventory(products) {
        ...
        products.forEach(item => {
            ...
            card.addEventListener("mouseleave", () => {
                card.style.backgroundColor = ""; // Visszaállítja a CSS-ben megadott alapértelmezett hátteret
                card.style.backgroundImage = `linear-gradient(to right, rgba(10, 15, 25, .95), rgba(5, 7, 13, .95))`;
                card.style.borderColor = `rgba(255, 255, 255, .06)`;
                card.style.transform = `translateY(0)`;
                card.style.boxShadow = "none";
            });

            // ELLENŐRZÉS: Kifogyott-e a termék?
            ...
            <div class="product-content">
                ...
                <p class="product-desc">
                    ${item.description || "Premium gaming hardware."}
                </p>
                ...
                <div>
                    ...
                    <span class="stock" style="color: ${isOutOfStock ? '#ef4444' : '#22c55e'}">
            ...
            <button
                ...
                style="${isOutOfStock ? "background: #ef4444; cursor: not-allowed; border-color: #ef4444;" : ""}"
            >
    ...
    function activateButtons() {
        document
            ...
            .forEach(btn => {
                // Csak azokra teszünk eseménykezelőt, amik nincsenek letiltva
